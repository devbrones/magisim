...
%% Mall för gymnasiearbete - Nacka Strands Gymnasium
%% -------------------------------------------------
%% CC0 This work has been marked as dedicated to the 
%% public domain. 
%% 
%%
...
\begin{document}
	\begin{titlepage}
		\noindent
		\includegraphics[width=0.15\paperwidth]{logo-mg.png} % NSG loggan :)
		% viktigt med mellanrum här
		...
		\vfill % lägg allt kul längst ned
		\noindent
		\begin{minipage}{\textwidth}
			\normalsize % 12pt
